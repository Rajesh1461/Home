    ...
    <div style={{ position: 'relative' }}>
      <div style={{ padding: '2rem', maxWidth: 1200, margin: '0 auto', background: 'rgba(255,255,255,0.5)', borderRadius: '40px 8px 40px 8px', position: 'relative', zIndex: 100 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', position: 'relative', zIndex: 101 }}>
          ...
          <div>
            <h2 style={{ position: 'relative', zIndex: 102, color: '#333', fontSize: '1.5rem', marginBottom: '1rem' }}>📋 Upload Guidelines</h2>
            <div style={{ 
              background: 'transparent', 
              padding: '2rem', 
              borderRadius: 12,
              ...
              <div style={{ marginBottom: '1.5rem', position: 'relative', zIndex: 103 }}>
                <h3 style={{ position: 'relative', zIndex: 104, color: '#222', marginBottom: '0.5rem' }}>📸 Photo Guidelines</h3>
                <ul style={{ position: 'relative', zIndex: 104, color: '#555', paddingLeft: '1.5rem' }}>
              ...
              <div style={{ marginBottom: '1.5rem', position: 'relative', zIndex: 103 }}>
                <h3 style={{ position: 'relative', zIndex: 104, color: '#222', marginBottom: '0.5rem' }}>🎥 Video Guidelines</h3>
                <ul style={{ position: 'relative', zIndex: 104, color: '#555', paddingLeft: '1.5rem' }}>
              ...
              <div style={{ marginBottom: '1.5rem', position: 'relative', zIndex: 103 }}>
                <h3 style={{ position: 'relative', zIndex: 104, color: '#222', marginBottom: '0.5rem' }}>🏷️ Tagging Tips</h3>
                <ul style={{ position: 'relative', zIndex: 104, color: '#555', paddingLeft: '1.5rem' }}>
              ...
              <div style={{ 
                ...
                <p style={{ position: 'relative', zIndex: 104, color: '#666', margin: 0 }}>
